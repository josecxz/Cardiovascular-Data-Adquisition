...
# Load the Excel file
data = pd.read_excel('Research_Square_Data.xlsx')  # Update with your file path if needed
...
df.to_excel('./Crossref_Data_Research_Square.xlsx', index=False)
